          ...
          {slides.map((m, i) => (
            <div key={i} className="w-full flex-shrink-0 px-2">
              <div className="w-full overflow-hidden">
                ...
                <span className="block text-base px-3 pb-3" style={{ fontFamily: 'cursive' }}>{m.time}</span>
                <div className="overflow-hidden">
                  <iframe
                    src={m.src}
                    width="100%"
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 bg-[#F3F5F9] sm:ml-10 lg:ml-12">
        ...
        <section className="relative overflow-hidden bg-[#FAFAFB]">
          <div className="">
            <div className="flex justify-center items-center py-12 lg:py-15">
              <h2 className="text-[#21417E] text-2xl sm:text-3xl lg:text-4xl font-bold mb-5 text-center" style={{ fontFamily: 'sans-serif' }}>
                BEST TREATMENT PLAN FOR YOU
              </h2>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="hidden lg:flex flex-row gap-8">
              ...
              <div className="w-1/2 flex flex-col">
                ...
                <span className="block text-lg pt-2 pb-4" style={{ fontFamily: 'cursive' }}>Timings: 9:00 AM - 1:00 PM</span>
              ...
              <div className="w-1/2 flex flex-col">
                ...
                <span className="block text-lg pt-2 pb-4" style={{ fontFamily: 'cursive' }}>Timings: 2:00 PM - 6:00 PM</span>
                <div className="overflow-hidden shadow-sm border border-gray-200">
                  <iframe
                    ...
                    <div className="inline-flex items-center gap-3">
                      {[
                        { 
                          ...
                          href: 'https://www.linkedin.com/company/seedsofinnocence/' 
                        },
                        { 
                          title: 'Facebook', 
                          ...
                          href: 'https://www.facebook.com/seedsofinnocenceIVF/' 
                        },
                        { 
                          title: 'Instagram', 
                          ...
                          href: 'https://www.instagram.com/seedsofinnocenceivf/' 
                        },
                        { 
                          title: 'YouTube', 
